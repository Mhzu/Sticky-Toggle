...
--==================================================
-- STICKY HEAD SETTINGS
--==================================================

local StickyEnabled = false
local StickinessValue = 2.0
local StickyRadiusValue = 10
...
local function GetClosestPlayer()
    ...
    for _, OtherPlayer in ipairs(Players:GetPlayers()) do
        if OtherPlayer ~= Player then
            ...
            if OtherRoot and OtherHead then
                local Distance = (MyRoot.Position - OtherRoot.Position).Magnitude
                if Distance <= StickyRadiusValue and Distance < ClosestDistance then
...
local function ReleaseSticky()
    CurrentTarget = nil
end

-- Sticky movement: higher StickinessValue = stronger/faster correction.
RunService.Heartbeat:Connect(function()
    ...
    if not CurrentTarget
        ...
        or not CurrentTarget.Character:FindFirstChild("Head") then
    ...
    -- Stop sticking once the target leaves the configured radius.
    local TargetDistance = (Root.Position - TargetRoot.Position).Magnitude
    if TargetDistance > StickyRadiusValue then
        CurrentTarget = GetClosestPlayer()
        if not CurrentTarget then return end
        TargetRoot = CurrentTarget.Character and CurrentTarget.Character:FindFirstChild("HumanoidRootPart")
        Head = CurrentTarget.Character and CurrentTarget.Character:FindFirstChild("Head")
        if not TargetRoot or not Head then
            CurrentTarget = nil
            return
        end
    ...
    local TargetPosition = Head.Position + Vector3.new(0, 1.6, 0)
    local Offset = TargetPosition - Root.Position
    local Distance = Offset.Magnitude

    if Distance > 0.05 then
        local Strength = math.clamp(StickinessValue / 10, 0, 1)
        local MaxSpeed = 8 + (StickinessValue * 4)

        local DesiredVelocity = Offset.Unit * math.min(Distance * MaxSpeed, MaxSpeed)
        local Velocity = Root.AssemblyLinearVelocity

        Root.AssemblyLinearVelocity = Vector3.new(
            Velocity.X + (DesiredVelocity.X - Velocity.X) * Strength,
            Velocity.Y,
            Velocity.Z + (DesiredVelocity.Z - Velocity.Z) * Strength
        )
    end
end)
...
function Library:CreateWindow(Settings)
    ...
    GalaxyBackground.Position = UDim2.new(0, 0, 0, 0)
    ...
    RunService.RenderStepped:Connect(function(DeltaTime)
        ...
        for _, Data in ipairs(AnimatedStars) do
            ...
            if Star.Parent then
                -- Move every dot continuously across the background.
                Data.X += (Data.Direction.X * Data.Speed * DeltaTime) / 1000
                Data.Y += (Data.Direction.Y * Data.Speed * DeltaTime) / 1000

                -- Wrap around the edges for endless movement.
                if Data.X > 1.02 then Data.X = -0.02 elseif Data.X < -0.02 then Data.X = 1.02 end
                if Data.Y > 1.02 then Data.Y = -0.02 elseif Data.Y < -0.02 then Data.Y = 1.02 end

                Star.Position = UDim2.new(Data.X, 0, Data.Y, 0)

                -- Gentle twinkle.
                local Wave = (math.sin(AnimationTime * Data.TwinkleSpeed + Data.Phase) + 1) / 2
    ...
    Main.BackgroundColor3 = Color3.fromRGB(9, 16, 13)
    ...
    MainStroke.Color = Color3.fromRGB(55, 220, 110)
    ...
    MainGradient.Color = ColorSequence.new({
        ColorSequenceKeypoint.new(0, Color3.fromRGB(9, 24, 16)),
        ColorSequenceKeypoint.new(0.5, Color3.fromRGB(14, 42, 25)),
        ColorSequenceKeypoint.new(1, Color3.fromRGB(7, 20, 13))
    })
    ...
    Title.Text = Settings.Name or "Sticky Toggle"
    ...
    Subtitle.Text = "CONTROL PANEL  •  STICKY SETTINGS"
    Subtitle.TextColor3 = Color3.fromRGB(125, 160, 140)
    Subtitle.TextSize = 9
    ...
    AccentLine.BackgroundColor3 = Color3.fromRGB(45, 190, 95)
    ...
    function self:CreateTab(TabName)
        ...
        TabButton.Size = UDim2.new(0, 155, 0, 30)
        TabButton.BackgroundColor3 = Color3.fromRGB(17, 34, 24)
        TabButton.BorderSizePixel = 0
        TabButton.Text = TabName
        TabButton.TextColor3 = Color3.fromRGB(170, 195, 180)
        TabButton.TextSize = 13
        TabButton.Font = Enum.Font.GothamSemibold
        TabButton.AutoButtonColor = false

        --// Keeps Sticky first and Misc second
        ...
        TabStroke.Color = Color3.fromRGB(45, 120, 70)
        ...
        Page.BackgroundColor3 = Color3.fromRGB(10, 22, 15)
    ...
    PageStroke.Color = Color3.fromRGB(42, 95, 61)
    ...
    PageStroke.Parent = Page
        ...
        function Tab:CreateButton(Settings)
            ...
            Button.BackgroundColor3 = Color3.fromRGB(16, 35, 24)
            ...
            ButtonStroke.Color = Color3.fromRGB(45, 120, 70)
        ...
        function Tab:CreateToggle(Settings)
            ...
            Holder.BackgroundColor3 = Color3.fromRGB(16, 35, 24)
            ...
            HolderStroke.Color = Color3.fromRGB(38, 78, 52)
            ...
            ToggleButton.BackgroundColor3 = Color3.fromRGB(30, 55, 41)
            ...
            Indicator.BackgroundColor3 = Color3.fromRGB(205, 215, 205)
            ...
            local function Update(Animate)
                ...
                if Enabled then
                    ...
                    ButtonColor = Color3.fromRGB(45, 205, 105)
                    ...
                    ButtonColor = Color3.fromRGB(30, 55, 41)
                    KnobPosition = UDim2.new(
                        0, 3,
                        0.5, -8
                    )
                ...
                if Animate then
                    ...
                    Indicator.Position = KnobPosition
            ...
            ToggleButton.MouseButton1Click:Connect(function()
                ...
                ToggleObject:SetValue(not Enabled)
        ...
        function Tab:CreateSlider(Settings)
            ...
            local Minimum = Settings.Min or 1
            local Maximum = Settings.Max or 10
            local Increment = Settings.Increment or 0.2
            local Value = Settings.Default or Minimum
            ...
            --// Between toggle and keybind
            Holder.LayoutOrder = 15
            ...
            Label.Position = UDim2.new(0, 11, 0, 2)
            Label.BackgroundTransparency = 1
            ...
            ValueLabel.TextColor3 = Color3.fromRGB(120, 220, 150)
            ...
            SliderBar.Size = UDim2.new(1, -22, 0, 5)
            SliderBar.Position = UDim2.new(0, 11, 0, 36)
            SliderBar.BackgroundColor3 = Color3.fromRGB(30, 55, 41)
            ...
            Fill.BackgroundColor3 = Color3.fromRGB(45, 205, 105)
            ...
            Knob.BackgroundColor3 = Color3.fromRGB(235, 245, 238)
        ...
        function Tab:CreateKeybind(Settings)
            ...
            Label.Position = UDim2.new(0, 11, 0, 0)
            Label.BackgroundTransparency = 1
            Label.Text = Settings.Name or "Keybind"
            Label.TextColor3 = Color3.fromRGB(255, 255, 255)
            Label.TextSize = 13
            Label.Font = Enum.Font.GothamSemibold
            Label.TextXAlignment = Enum.TextXAlignment.Left
            ...
            KeyButton.Size = UDim2.new(0, 82, 0, 26)
            KeyButton.Position = UDim2.new(1, -91, 0.5, -13)
            KeyButton.BackgroundColor3 = Color3.fromRGB(20, 52, 33)
            ...
            UserInputService.InputBegan:Connect(function(Input, GameProcessed)
                ...
                if Listening then
                    ...
                    if IsKeyboard or IsController then
...
local Sticky = Window:CreateTab("Sticky")

Sticky:CreateLabel("Sticky Toggle")

local StickyToggle = Sticky:CreateToggle({
    ...
    Callback = function(Value)
        ...
        print("Sticky Toggle:", StickyEnabled)
...
local Stickiness = Sticky:CreateSlider({
    ...
    Callback = function(Value)
        ...
        StickinessValue = Value

        print("Sticky:", StickinessValue)
...
-- STICKY RADIUS
--==================================================
local StickyRadius = Sticky:CreateSlider({
    Name = "Sticky Radius",
    Min = 5,
    Max = 100,
    Increment = 5,
    Default = 10,
    Callback = function(Value)
        StickyRadiusValue = Value
        print("Sticky Radius:", StickyRadiusValue)
    end
})
...
Sticky:CreateKeybind({

    Name = "Sticky Toggle Keybind",

    Callback = function()

        StickyToggle:SetValue(
            not StickyToggle:GetValue()
        )
...
--==================================================
-- GUI SHOW / HIDE KEYBIND
-- Works with keyboard/mouse AND controller
-- The keybind listener stays active even while the GUI is hidden.
--==================================================
